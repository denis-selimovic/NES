...
cpu6502::cpu6502() {
    lookup = {
            ...
            {Instruction("BMI", 2, &Operation::BMI, &AddressingMode::REL), Instruction("AND", 5, &Operation::AND, &AddressingMode::IZY), Instruction("XXX", 0, nullptr, nullptr), Instruction("XXX", 0, nullptr, nullptr), Instruction("XXX", 0, nullptr, nullptr), Instruction("AND", 4, &Operation::AND, &AddressingMode::ZPX), Instruction("ROL", 6, &Operation::ROL, &AddressingMode::ZPX), Instruction("XXX", 0, nullptr, nullptr),
             Instruction("SEC", 2, &Operation::SEC, &AddressingMode::IMP), Instruction("AND", 4, &Operation::AND, &AddressingMode::ABY), Instruction("XXX", 0, nullptr, nullptr), Instruction("XXX", 0, nullptr, nullptr), Instruction("XXX", 0, nullptr, nullptr), Instruction("AND", 4, &Operation::AND, &AddressingMode::ABX), Instruction("ROL", 7, &Operation::ROL, &AddressingMode::ABX), Instruction("XXX", 0, nullptr, nullptr)},
            {},
            {},
            {},
            {},
